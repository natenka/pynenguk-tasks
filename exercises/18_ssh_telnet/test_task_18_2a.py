...
def test_function_return_value(capsys, r1_test_connection, first_router_from_devices_yaml):
    """
    ...
    return_value = task_18_2a.send_config_commands(first_router_from_devices_yaml, test_commands)
    ...
    return_value = task_18_2a.send_config_commands(first_router_from_devices_yaml, test_commands, log=False)
    correct_stdout = ""
    stdout, err = capsys.readouterr()
    assert correct_stdout == stdout, "Повідомлення про помилку не повинно виводитись на stdout, коли log=False"
