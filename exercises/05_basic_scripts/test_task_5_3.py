...
def test_task_r2(capsys, monkeypatch):
    ...
    assert str(r2_dict) in out.strip(), "На стандартний потік виведення виводиться неправильний вивід"
...
def test_task_sw1(capsys, monkeypatch):
    ...
    assert str(sw1_dict) in out.strip(), "На стандартний потік виведення виводиться неправильний вивід"
