...
def test_task_variables():
    ...
    if not isinstance(task_4_3.result, list):
        pytest.fail(f"За завданням у змінній result має бути список, а в ній {type(task_4_3.result).__name__}")
    assert correct_result == task_4_3.result, f"У змінній result має бути список {correct_result}"
