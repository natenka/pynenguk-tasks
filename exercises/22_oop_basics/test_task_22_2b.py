...
def test_send_config_commands_list(first_router_from_devices_yaml):
    ...
    assert cfg_comands[0] in return_value and cfg_comands[1] in return_value, "Метод send_config_commands повертає неправильне значення"
...
def test_send_config_command_str(first_router_from_devices_yaml):
    ...
    assert cfg_comand in return_value, "Метод send_config_commands повертає неправильне значення"
