...
def test_templates_exists():
    assert os.path.exists("templates/add_vlan_to_switch.txt"), "Шаблон templates/add_vlan_to_switch.txt не існує"
...
def test_function_return_value():
    ...
    assert correct_value_vlan in return_value, "У підсумковій конфігурації не створено VLAN та/або не призначено ім'я VLAN"
    assert correct_value_access in return_value, "У підсумковій конфігурації неправильне налаштування access"
    assert (
